        ...
        <div class="box-body table-responsive">
            <div class="row">
                    ...
                    <div style="margin-bottom:5px;">
                        <nav aria-label="...">
                            <ul class="pagination" style="margin: 0px !important">
                                <li class="page-item">
                                    <a class="page-link" href="{{ route('admin.proses_clustering.nilai_cluster_satu',[$max]) }}">Previous</a>
                                </li>
                                ...
                                <li class="page-item">
                                <a class="page-link" href="{{ route('admin.proses_clustering.nilai_cluster_tiga',[$max]) }}">Next</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
                ...
                <div class="col-md-12" style="margin-bottom: 10px;">
                    <form action="{{ route('admin.proses_clustering.generate_nilai_cluster_dua',[$max]) }}" method="POST">
                        @csrf {{ method_field('POST') }}
                        <button class="btn btn-primary btn-sm" type="submit"><i class="fa fa-refresh fa-spin"></i>&nbsp; Generate Nilai Cluster 2</button>
                    </form>
                </div>
                <div class="col-md-12">
