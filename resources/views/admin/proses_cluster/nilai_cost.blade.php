    ...
    <div class="box box-primary">
        ...
        <div class="box-body table-responsive">
            <div class="row">
                ...
                <div class="col-md-12">
                    <a style="margin-bottom: 10px;" href="{{ route('admin.proses_clustering') }}" class="btn btn-success btn-sm"><i class="fa fa-arrow-left"></i>&nbsp; Kembali ke pusat cluster</a>
                    ...
                    <div style="margin-bottom:5px;">
                        <nav aria-label="...">
                            <ul class="pagination" style="margin: 0px !important">
                                <li class="page-item">
                                    <a class="page-link" href="{{ route('admin.proses_clustering.cluster',[$max]) }}">Previous</a>
                                </li>
                ...
                <div class="col-md-12" style="margin-bottom: 10px;">
                    <form action="{{ route('admin.proses_clustering.generate_nilai_cost',[$max]) }}" method="POST">
                        @csrf {{ method_field('POST') }}
                        <button class="btn btn-primary btn-sm" type="submit"><i class="fa fa-refresh fa-spin"></i>&nbsp; Generate Nilai Cost</button>
                    </form>
                </div>
                <div class="col-md-12">
